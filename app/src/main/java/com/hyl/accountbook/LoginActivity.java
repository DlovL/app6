...
public class LoginActivity extends AppCompatActivity {
    ...
    public void OnMyLoginClick(View v){
        if(pubFun.isEmpty(editPhone.getText().toString()) || pubFun.isEmpty(editPwd.getText().toString())){
            Toast.makeText(this, "phone number and password can not be null！", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(c!=null && c.getCount() >= 1){
            ...
            Toast.makeText(this, "phone number or password error！", Toast.LENGTH_SHORT).show();
        }
    }
